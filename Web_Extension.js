...
function add_info() {
  ...
  dom.innerHTML = "先点击自动填写，再点击上面的按钮，最后提交即可";
  parent.insertBefore(dom, document.querySelectorAll(".chkBox")[2].nextSibling);
}
...
const targetNode = document.getElementById("p3");
...
const callback = function (mutationsList, observer) {
  for (let mutation of mutationsList) {
    if (mutation.type === "attributes") {
      ...
      // Part2
      // console.log("监测到名额，已填写信息");
      // add_info();
      // setInterval(input_value(), 1000);
    }
  }
};
